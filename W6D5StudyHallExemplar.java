...
public class W6D5StudyHallExemplar {
	...
	private static String executeFSM(String input) {
		...
		case 2:
			...
			return "This character must be a 2, 4, 6, or an 8 in order to be even.\n" +
					displayInput(input, currentCharNdx);
		...
		case 3:
			...
			if (currentCharNdx<=input.length())
				return "This character must be 0, 2, 4, 6, or 8 to be an even value.\n" +
					displayInput(input, currentCharNdx);
	...
	public static void main(String[] args) {
		...
		System.out.println("prited by jawahar\n");
